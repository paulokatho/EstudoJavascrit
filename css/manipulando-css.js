$(function() {
	...
	function estilizarLinhaUsuarios() {
		...
		/* .parents('tr') pega valores de pais acima, tipo herança, sai varrendo a hierarquia
			.parent --sem o 's' pega somente um nível de hierarquia acima
			'tr' pega o elemento <tr>, #tr pega por ID e .tr pega a classe.
		*/
	}
